...
# -*- coding: utf-8 -*-
"""
نظام نشر الأخبار التلقائي على فيسبوك - النسخة 7
...
PAGES_CONFIG = {
    "1104346172760947": {
        "name": "صلصال",
        "token": os.environ.get("PAGE_SALSSAL", "EAAR0aK9LrrUBRjMUQPBkXMMsPZC4tAO9ZCVovSNhfqQ2k49u7uKyM6e1g4xH9gXiUBZCZAuYTDi8Whx1GU2UH4VyIMEJIuljKzHvq1n2euS4cPlOgWhLQ7QAyXX6jxQGpSJS3g21iFx8dwzqb0GVOb6R2gaTAHHGp9FaFZBETCudW7fL7kDAuZAxMbO1zbPpoTRIfZCUj8O"),
        "color": (255, 107, 107),
        "bg_color": (255, 229, 229),
    },
    "1078693568663658": {
        "name": "چاي سادة",
        "token": os.environ.get("PAGE_CHAI", "EAAR0aK9LrrUBRvZAqZBOP4sM1fpBdsEprslIARu89YCSEuxZCC76HIwpnBznV2MYxUQsh7N6W3yX4UPTL1tSHdk9sOVTdaZB4I9J5tbOrAg94VS5szKlq83Xq7PhkBZB6PlJy24ZA2lRaTLo1Mjl63iwZC0H3Yk9jowyLVaUYkZBLhkIXbs74cMDDPOpJZB1a2a4d6Q1jIIZBV"),
        "color": (139, 115, 85),
        "bg_color": (212, 165, 116),
    },
    "1063874040148711": {
        "name": "طابوگة",
        "token": os.environ.get("PAGE_TABOGA", "EAAR0aK9LrrUBRt3ZBKZAY53vOK2iWDJxR1qZApfS2ZA2s7V0nVFDVKUMEsBsp3ZCwWPbUeK8jIr6Ldt9FFStKEQ8Hdmlna10IRycYiAISU9bssKgUSuzJdeXSw5lPFh0p20NwuvK3EpwaYZBF6w5z7mjyZAJQHj6gK5GfZA0ZCazZBrkvaLfYNZAAtzq8OF5qcufMZBzXo9m"),
        "color": (78, 205, 196),
        "bg_color": (224, 247, 246),
    },
    "1094102397116855": {
        "name": "طين",
        "token": os.environ.get("PAGE_TEIN", "EAAR0aK9LrrUBRvZA1ZBKZAY53vOK2iWDJxR1qZApfS2ZA2s7V0nVFDVKUMEsBsp3ZCwWPbUeK8jIr6Ldt9FFStKEQ8Hdmlna10IRycYiAISU9bssKgUSuzJdeXSw5lPFh0p20NwuvK3EpwaYZBF6w5z7mjyZAJQHj6gK5GfZA0ZCazZBrkvaLfYNZAAtzq8OF5qcufMZBzXo9m"),
        "color": (160, 130, 109),
...
# قاعدة البيانات
# =====================================================
DB_PATH = "/home/Haiderbasim/published.db"
    ...
    try:
        ...
        if post_image:
            ...
            if response.status_code == 200:
                ...
                print(f"❌ فشل النشر على {page_config['name']}: {response.text}")
                return False
        else:
